...
const ASSETS = ['./', './index.html', './lib/three.module.js', './lib/GLTFLoader.js', './lib/BufferGeometryUtils.js', './models/soldier.glb', './models/weapons.glb', './shared/map.mjs', './shared/weapons.mjs', './manifest.json', './icon.svg'];
